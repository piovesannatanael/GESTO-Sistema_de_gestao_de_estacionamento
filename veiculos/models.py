...
class Veiculo(models.Model):
    ...
    '''cliente = models.ManyToManyField(clientes.models.ClientePF and clientes.models.ClientePJ, verbose_name='Cliente PF', help_text="Nome do cliente",
                                related_name='cliente')'''
    content_type = models.ForeignKey(ContentType, on_delete=models.PROTECT) # Usamos PROTECT aqui
